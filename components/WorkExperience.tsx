...
const WorkExperience = ({ experience }: { experience: Experience[] }) => {
  return (
    ...
    >
      ...
      <div className="w-full px-10 mt-[30px] flex space-x-5 overflow-x-scroll snap-x snap-mandatory overflow-y-hidden scrollbar-thin  scrollbar-thumb-[#35C6F4] scrollbar-track-gray-400/20  z-30  ">
        {experience.map((exp) => (
